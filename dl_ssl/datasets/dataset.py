...
from dl_ssl.utils.transforms import basic_transform
...
class UnlabeledDataset(torch.utils.data.Dataset):
    def __init__(self, root, img_size, unlabelled = True):
        r"""
        Args:
            root: Location of the dataset folder, usually it is /unlabeled
            img_size: the image resizing you want to apply to the images.
        """
        self.transform = basic_transform(img_size, unlabelled = unlabelled)
